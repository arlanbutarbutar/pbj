...
<head>
    ...
    <title><?php echo $_SESSION['level']; ?> - Laporan Bulanan</title>
...
<body id="page-top">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3 d-flex justify-content-between">
                            ...
                            <button type="button" class="btn btn-info" data-toggle="modal" data-target="#bulanan_stock">
                                <i class="bi bi-printer-fill"> Cetak Laporan</i>
                            </button>
                            <div class="modal fade" id="bulanan_stock" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <form action="export_bulanan_stock.php" method="post">
                                            <div class="modal-body">
                                                <div class="form-group">
                                                    <label for="month">Pilih Bulan yang mau dicetak</label>
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3 d-flex justify-content-between">
                            ...
                            <button type="button" class="btn btn-info" data-toggle="modal" data-target="#bulanan_masuk">
                                <i class="bi bi-printer-fill"> Cetak Laporan</i>
                            </button>
                            <div class="modal fade" id="bulanan_masuk" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="exampleModalLabel"></h5>
                                        ...
                                        <form action="export_bulanan_masuk.php" method="post">
                                            <div class="modal-body">
                                                <div class="form-group">
                                                    <label for="month">Pilih Bulan yang mau dicetak</label>
                                                    <input type="month" name="month" class="form-control" id="month" required>
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3 d-flex justify-content-between">
                            ...
                            <button type="button" class="btn btn-info" data-toggle="modal" data-target="#bulanan_keluar">
                                <i class="bi bi-printer-fill"> Cetak Laporan</i>
                            </button>
                            <div class="modal fade" id="bulanan_keluar" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="exampleModalLabel"></h5>
                                        ...
                                        <form action="export_bulanan_keluar.php" method="post">
                                            <div class="modal-body">
                                                <div class="form-group">
                                                    <label for="month">Pilih Bulan yang mau dicetak</label>
                                                    <input type="month" name="month" class="form-control" id="month" required>
    ...
    $query1 = "SELECT DATE_FORMAT(created_at, '%Y-%m') AS bulan, SUM(jumlah_seluruh) AS total_barang FROM stock_barang GROUP BY created_at";

    $result1 = mysqli_query($conn, $query1);
    $data_stok = array();
    while ($row = mysqli_fetch_assoc($result1)) {
        $data_stok[$row['bulan']] = $row['total_barang'];
    }

    // Query untuk mengambil data
    $query2 = "SELECT DATE_FORMAT(created_at, '%Y-%m') AS bulan, SUM(jumlah_barang) AS total_barang FROM barang_masuk GROUP BY created_at";

    $result2 = mysqli_query($conn, $query2);
    $data_masuk = array();
    while ($row = mysqli_fetch_assoc($result2)) {
        $data_masuk[$row['bulan']] = $row['total_barang'];
    }

    // Query untuk mengambil data
    $query3 = "SELECT DATE_FORMAT(created_at, '%Y-%m') AS bulan, SUM(jumlah_keluar) AS total_barang FROM barang_keluar GROUP BY created_at";

    $result3 = mysqli_query($conn, $query3);
    $data_keluar = array();
    while ($row = mysqli_fetch_assoc($result3)) {
        $data_keluar[$row['bulan']] = $row['total_barang'];
    }
    ?>
    <script>
        ...
        // Data dari PHP
        var dataStok = <?php echo json_encode($data_stok); ?>;
        var dataMasuk = <?php echo json_encode($data_masuk); ?>;
        var dataKeluar = <?php echo json_encode($data_keluar); ?>;
