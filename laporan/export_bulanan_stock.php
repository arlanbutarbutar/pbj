...
if (isset($_POST['month'])) {
    ...
    $tampil = mysqli_query($conn, "SELECT * FROM stock_barang WHERE MONTH(created_at) = $month AND YEAR(created_at) = $year");
}

$pdf->Cell(10, 30, 'Laporan Stock Bulan ' . $month_view . ' ' . $year, 0, 1, 'C');
