...
if (isset($_POST['year'])) {
    $year = $_POST['year'];
    $tampil = mysqli_query($conn, "SELECT * FROM barang_keluar k, stock_barang s WHERE s.kode_stok = k.kode_stok AND YEAR(k.created_at) = $year");
}

$pdf->Cell(110, 30, 'Laporan Barang Keluar Tahunan ' . $year, 0, 1, 'C');
